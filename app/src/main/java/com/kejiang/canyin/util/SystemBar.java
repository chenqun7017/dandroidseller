...
public class SystemBar {
	...
	public SystemBar(Activity activity) {
	...
	public static class SystemBarConfig {
		 ...
		 * 
		 * @return The nbsp;width of the navigation bar (in pixels). If the
		 *         device does not have soft navigation keys, this will always
		 *         return 0.
		 */
